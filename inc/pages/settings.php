...
function ecc_admin_settings_page() {
    ...
    <form method="post" action="">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><label for="debug_mode">Enable Debug Logging</label></th>
                <td>
                    ...
                    <p class="description">When enabled, the plugin will output debug information to the browser console (tracking blocker actions, consent changes, etc.).</p>
                </td>
            </tr>
        </table>
