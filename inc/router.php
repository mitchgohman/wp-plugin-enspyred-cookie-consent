...
function ecc_handle_settings_submission() {
    ...
    $settings = [
        ...
        'cookie_policy_new_window' => !empty($_POST['cookie_policy_new_window']),
        'privacy_policy_text' => isset($_POST['privacy_policy_text']) ? sanitize_text_field(wp_unslash($_POST['privacy_policy_text'])) : '',
        'privacy_policy_url' => isset($_POST['privacy_policy_url']) ? esc_url_raw(wp_unslash($_POST['privacy_policy_url'])) : '',
        'privacy_policy_new_window' => !empty($_POST['privacy_policy_new_window']),
